...
typedef RT_MODEL_BimanualHD2LfD_2016a_T RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * BimanualHD2LfD_2016a(void);
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(BimanualHD2LfD_2016a_M, GBLbuf.message);
}
  ...
  control_c_handler(int signal_number)
{
  ...
  {
    pstream_shutdown(BimanualHD2LfD_2016a_DW.StreamServerRecv_Stream);
    pstream_shutdown(BimanualHD2LfD_2016a_DW.StreamServerSend_Stream);
  }
}
  ...
  main(int argc, char * argv[])
{
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: BimanualHD2LfD_2016a -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
